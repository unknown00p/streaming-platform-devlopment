...
function UploadVideo() {
    ...
    return (
        ...
        <div className="fixed top-[3rem] left-0 right-0 max-w-xl m-auto bg-black text-white p-4 sm:p-6 md:p-8 h-[calc(100vh-3rem)]">
          <div className="max-w-xl mx-auto pt-3 h-full flex flex-col">
            ...
            <div className="overflow-y-auto scrollbar flex-grow innerPart">
              <div className="bg-gray-900 rounded-lg p-4 sm:p-2 overflow-auto">
              ...
              <div className="flex flex-col gap-2 mt-4 pb-3">
                <Input className="border-2 p-2 w-full" type="file" label="thumbnail" />
                <div>
                  <Input className="w-full h-11 px-2 outline-none bg-[#fff0] border-white border-2" type="text" label="title" />
                </div>
                <div>
                  <Input className="w-full h-11 px-2 outline-none bg-[#fff0] border-white border-2" type="text" label="description" />
                </div>
              </div>
            </div>
          </div>
